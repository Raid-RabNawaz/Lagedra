namespace Lagedra.Modules.LeaseAgreements.Application.Templates;

/// <summary>
/// Canonical US-CA lease body. Layout and clause text follow the California
/// Lease Agreement used in production DocuSign packets (run-in bold headings,
/// statutory addenda, signature blocks). Deal-specific values are
/// <c>{{placeholder}}</c> tokens resolved by <c>LeaseAgreementFiller</c>.
/// </summary>
public static class CaliforniaLeaseTemplateHtml
{
    public const string Title = "California Lease Agreement";
